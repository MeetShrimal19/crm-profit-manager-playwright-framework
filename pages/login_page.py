...
class LoginPage:
    ...
    def login(self, username, OTP1, OTP2, OTP3, OTP4, OTP5, OTP6):
        ...
        self.logger.info(f"Entering OTP1 value {OTP2}")
        self.page.fill(LoginLocator.OTP2, OTP2)
        self.logger.info(f"Entering OTP1 value {OTP3}")
        self.page.fill(LoginLocator.OTP3, OTP3)
        self.logger.info(f"Entering OTP1 value {OTP4}")
        self.page.fill(LoginLocator.OTP4, OTP4)
        self.logger.info(f"Entering OTP1 value {OTP5}")
        self.page.fill(LoginLocator.OTP5, OTP5)
        self.logger.info(f"Entering OTP1 value {OTP6}")
